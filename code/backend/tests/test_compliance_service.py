...
class TestComplianceService:
    ...
    def test_aml_screening_clean(self, compliance_service, sample_user_data):
        ...
        with patch.object(compliance_service, '_check_sanctions_lists') as mock_sanctions, \
             patch.object(compliance_service, '_check_pep_lists') as mock_pep, \
             patch.object(compliance_service, '_analyze_transaction_patterns') as mock_patterns:
    ...
    def test_aml_screening_suspicious(self, compliance_service, sample_user_data):
        ...
        with patch.object(compliance_service, '_check_sanctions_lists') as mock_sanctions, \
            ...
            mock_sanctions.return_value = {'match': True, 'confidence': 0.9, 'list_name': 'OFAC SDN'}
            mock_pep.return_value = {'match': False, 'confidence': 0.0}
    ...
    def test_transaction_monitoring_normal(self, compliance_service):
        ...
        with patch.object(compliance_service, '_analyze_transaction_risk') as mock_analyze:
    ...
    def test_transaction_monitoring_suspicious(self, compliance_service):
        ...
        with patch.object(compliance_service, '_analyze_transaction_risk') as mock_analyze:
            mock_analyze.return_value = {
                'risk_score': 0.8,
                'risk_factors': ['large_amount', 'cash_transaction', 'unknown_counterparty'],
    ...
    def test_watchlist_screening(self, compliance_service):
        ...
        with patch.object(compliance_service, '_screen_against_watchlists') as mock_screen:
    ...
    def test_transaction_pattern_analysis(self, compliance_service):
        ...
        with patch.object(compliance_service, '_analyze_transaction_patterns') as mock_analyze:
            mock_analyze.return_value = {
                'suspicious': True,
    ...
    def test_compliance_configuration_validation(self, compliance_service):
        ...
        assert 'validation_errors' not in result or len(result['validation_errors']) == 0
