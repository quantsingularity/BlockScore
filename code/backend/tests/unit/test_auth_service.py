...
class TestAuthenticationService:
    ...
    def test_register_user_success(self, auth_service, db, sample_user_data):
    ...
    def test_register_user_duplicate_email(self, auth_service, db, sample_user):
    ...
    def test_register_user_invalid_email(self, auth_service, db):
    ...
    def test_register_user_weak_password(self, auth_service, db):
    ...
    def test_authenticate_user_success(self, auth_service, db, sample_user):
    ...
    def test_authenticate_user_invalid_email(self, auth_service, db):
    ...
    def test_authenticate_user_wrong_password(self, auth_service, db, sample_user):
    ...
    def test_authenticate_user_inactive_account(self, auth_service, db, sample_user):
    ...
    def test_authenticate_user_unverified_email(self, auth_service, db, sample_user):
    ...
    def test_validate_token_success(self, auth_service, db, sample_user):
    ...
    def test_validate_token_expired(self, auth_service, db, sample_user):
    ...
    def test_validate_token_invalid(self, auth_service, db):
    ...
    def test_refresh_token_success(self, auth_service, db, sample_user):
    ...
    def test_refresh_token_invalid(self, auth_service, db):
    ...
    def test_refresh_token_expired(self, auth_service, db, sample_user):
    ...
    def test_logout_user_success(self, auth_service, db, sample_user):
    ...
    def test_logout_user_invalid_session(self, auth_service, db, sample_user):
    ...
    def test_change_password_success(self, auth_service, db, sample_user):
    ...
    def test_change_password_wrong_current(self, auth_service, db, sample_user):
    ...
    def test_change_password_weak_new_password(self, auth_service, db, sample_user):
    ...
    def test_reset_password_request_success(self, auth_service, db, sample_user):
    ...
    def test_reset_password_request_invalid_email(self, auth_service, db):
    ...
    def test_reset_password_success(self, auth_service, db, sample_user):
    ...
    def test_reset_password_invalid_token(self, auth_service, db):
    ...
    def test_reset_password_expired_token(self, auth_service, db, sample_user):
    ...
    def test_enable_mfa_success(self, auth_service, db, sample_user):
        ...
        # Verify user MFA settings
        updated_user = User.query.get(sample_user.id)
        assert updated_user.mfa_secret is not None
    
    def test_verify_mfa_success(self, auth_service, db, sample_user):
    ...
    def test_verify_mfa_invalid_token(self, auth_service, db, sample_user):
    ...
    def test_disable_mfa_success(self, auth_service, db, sample_user):
        ...
        with patch.object(auth_service, 'verify_mfa_token', return_value={'valid': True}):
    ...
    def test_get_user_sessions(self, auth_service, db, sample_user):
        ...
        assert all('session_token' not in session for session in sessions)  # Sensitive data hidden
        assert all('ip_address' in session for session in sessions)
    
    def test_revoke_session_success(self, auth_service, db, sample_user):
    ...
    def test_audit_logging(self, auth_service, db, sample_user):
        ...
        login_log = next((log for log in audit_logs if log.event_type == 'user_login'), None)
    ...
    def test_rate_limiting(self, auth_service, db, sample_user):
        ...
        with patch.object(auth_service, '_verify_password', return_value=True):
            result = auth_service.authenticate_user(sample_user.email, 'correct_password')
        
        assert result['success'] is False
        assert 'rate limit' in result['message'].lower()
    
    def test_security_headers(self, auth_service, db, sample_user):
        """Test security-related functionality"""
        # Test that sensitive operations update security timestamps
        with patch.object(auth_service, '_verify_password', return_value=True):
