...
class User(db.Model):
    ...
    password_changed_at = db.Column(db.DateTime(timezone=True), default=datetime.now(timezone.utc))
...
class UserProfile(db.Model):
    ...
    kyc_documents = db.Column(db.Text, nullable=True)  # JSON array of document references
