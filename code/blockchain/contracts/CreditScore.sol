...
contract CreditScore {
    ...
    function addCreditRecord(
        ...
        require(
            scoreImpact >= -10 && scoreImpact <= 10,
            "Score impact must be between -10 and 10"
        );
    ...
    function markRepaid(
        ...
        require(
            recordIndex < creditHistory[user].length,
            "Record index out of bounds"
        );
        require(
            !creditHistory[user][recordIndex].repaid,
            "Record already marked as repaid"
        );
