...
contract LoanContractV2 is ReentrancyGuard, Pausable, AccessControl, EIP712 {
    ...
    function submitLoanApplication(
        ...
        bytes32 structHash = keccak256(abi.encode(
            keccak256("LoanApplication(address applicant,uint256 amount,uint256 term,uint256 income,uint256 nonce)"),
            msg.sender,
            requestedAmount,
            requestedTermDays,
            annualIncome,
    ...
    function makePayment(
        ...
        emit PaymentMade(loanId, msg.sender, paymentAmount, principalPortion, interestPortion, block.timestamp);
    }
    ...
    function liquidateLoan(uint256 loanId) external onlyRole(LIQUIDATOR_ROLE) nonReentrant {
        ...
        uint256 outstandingAmount = loan.terms.principalAmount - loan.amountRepaid;
        uint256 lossAmount = outstandingAmount > recoveredAmount ? outstandingAmount - recoveredAmount : 0;
