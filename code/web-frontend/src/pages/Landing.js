          ...
          {[
            {
              ...
              description: 'All credit data is securely stored on the blockchain, ensuring transparency and immutability.'
            },
            {
              icon: <SpeedIcon sx={{ fontSize: 50, color: theme.palette.primary.main }} />,
              title: 'Real-time Updates',
              description: 'Credit scores are updated in real-time as new transactions are recorded on the blockchain.'
            },
            {
              icon: <AccountBalanceIcon sx={{ fontSize: 50, color: theme.palette.primary.main }} />,
              title: 'Fair Lending',
              description: 'AI-powered scoring models ensure fair and unbiased credit assessment for all users.'
            }
          ].map((feature, index) => (
      ...
      <Box sx={{
        ...
        <Container maxWidth="lg">
          ...
          <Typography variant="body2" color="text.secondary" align="center" sx={{ mt: 1 }}>
            Powered by blockchain technology for secure and transparent credit scoring
          </Typography>
        </Container>
      </Box>
    </Box>
