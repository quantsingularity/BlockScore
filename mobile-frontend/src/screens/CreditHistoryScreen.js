...
const CreditHistoryScreen = () => {
  ...
  // Sample history data
  const historyData = [
    { date: 'APR 15', title: 'Loan Payment', description: 'On-time payment recorded', scoreChange: 5 },
    { date: 'MAR 22', title: 'Credit Inquiry', description: 'Mortgage pre-approval', scoreChange: -2 },
    { date: 'MAR 10', title: 'Credit Card Payment', description: 'Paid in full', scoreChange: 3 },
    { date: 'FEB 28', title: 'Loan Payment', description: 'On-time payment recorded', scoreChange: 5 },
    { date: 'JAN 15', title: 'New Credit Card', description: 'Account opened', scoreChange: -1 },
  ];
    ...
    <ScrollView style={styles.container}>
      ...
      <View style={styles.historyContainer}>
        ...
        {historyData.map((item, index) => (
          <View key={index} style={[styles.historyItem, index === historyData.length - 1 ? styles.historyItemLast : null]}>
            ...
            <View style={styles.historyScore}>
              <Text style={[styles.scoreChange, item.scoreChange < 0 ? styles.negative : styles.positive]}>
      ...
      <TouchableOpacity style={styles.actionButton} onPress={handleViewFullHistory}>
        <Icon name="description" type="material" color={colors.cardBackground} size={responsiveFontSize(2.5)} style={styles.buttonIcon} />
